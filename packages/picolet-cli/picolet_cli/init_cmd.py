...
_KNOWN_TEMPLATES: frozenset[str] = frozenset({"hello-cli", "hello-webview", "hello-lvgl", "hello-vue", "pydfu", "notes", "config-editor"})
...
def add_parser(subparsers) -> None:
    ...
    p.add_argument(
        "--template",
        default="hello-cli",
        help='template to use (default: hello-cli; available: "hello-cli", "hello-webview", "hello-lvgl", "hello-vue", "pydfu", "notes", "config-editor")',
    )
    p.add_argument(
        "--output-dir",
        default=None,
