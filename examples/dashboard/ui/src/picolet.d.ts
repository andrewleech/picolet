 ...
 *
 * Declares the window.picolet bridge surface so Vue/TS components get typed
 * access to invoke, on, emit, and _drainPending without any extra import.
 *
 * FR-VUE-3
 */
...
declare global {
  ...
  interface Window {
    ...
    __PICOLET_SCREENSHOT_MODE__?: boolean;
  }
}
